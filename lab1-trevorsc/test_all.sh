...
# Mandatory Tests
grade_test "${ID_MAND}" triangular 1
grade_test "${ID_MAND}" triangular 2
grade_test "${ID_MAND}" triangular 3
grade_test "${ID_MAND}" triangular 4
grade_test "${ID_MAND}" triangular 5
grade_test "${ID_MAND}" bubblesort 1
grade_test "${ID_MAND}" bubblesort 2
grade_test "${ID_MAND}" bubblesort 3
grade_test "${ID_MAND}" bubblesort 4
grade_test "${ID_MAND}" bubblesort 5
